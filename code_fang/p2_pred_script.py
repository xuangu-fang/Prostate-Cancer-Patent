...
# last three columns of p2 are labels
all_feature_cont = data_table_cont.iloc[:,1:-3]
all_feature_binary = data_table_binary.iloc[:,1:-3]
# all_feature_binary

# for P2 patients, we use continues/binary process data
...
print('sub-target is:',sub_target)
...
for metric_name in mertric_list:
    ...
    for rand_seed,result_table in zip(seed_list,result_table_list):
        ...
        # file_name = path_str+'/P2_pred_'+target+ '_'+ metric_name+ str(rand_seed)+ '.csv'
